 //http://bitovi.com/blog/2010/10/jquery-model-a-jquery-model-layer.html
 $(document).ready(function () {
    $("#id_tipo_plaza").change(function(){
      if ($(this).val() == 'O'){
        $("#especificacion").attr("hidden", false);
      }
      else{
       $("#especificacion").attr("hidden", true); 
      }
    });
  });
