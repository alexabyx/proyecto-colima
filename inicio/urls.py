...
urlpatterns = patterns('proyecto_colima.inicio',
    ...
    url(r'^modal_alarma/$', modal_alarma, name="modal-alarma"),
    
    #EN HISTORICO
    url(r'^en_historico/$', en_historico, name="en-historico"),
    ...
    #HOMOLOGACION DE DOCUMENTOS
    url(r'^homologacion/$', homologacion, name='homologacion'),
    url(r'^detalle_homologacion/(?P<pk>\d+)/$', HomologacionDetailView.as_view(), name='detalle-homologacion'),    
    url(r'^editar_homologacion/(?P<pk>\d+)/$', editar_homologacion, name='editar-homologacion'),
    url(r'^crear_homologacion/$', crear_homologacion, name='crear-homologacion'),
    
    #ALARMAS
    url(r'^crear_alarma/$', crear_alarma, name='crear-alarma'),
    )