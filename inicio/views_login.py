...
from inicio.models import Alarmas
...
def administracion(request):
	alarmas = Alarmas.objects.filter(receptor = request.user).order_by('-fecha_vencimiento')
	return render(request, 'inicio/administracion.html',{'alarmas': alarmas},context_instance=RequestContext(request))