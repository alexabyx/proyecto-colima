...
def modal_alarma(request):
	alarma = int(request.GET.get('id', -1))
	alarma = Alarmas.objects.get(pk=alarma)
	return render(request, 'inicio/alarma_detail.html', {'alarma': alarma})