...
class DetallesEntregablesInline(admin.TabularInline):
...
class EntregablesAdmin(admin.ModelAdmin):
	...
	inlines = [DetallesEntregablesInline]
...
class DetallesDocumentosGeneralesInline(admin.TabularInline):
...
class DocumentosGeneralesAdmin(admin.ModelAdmin):
	...
	inlines = [DetallesDocumentosGeneralesInline]
